"""
Velocity Polish - Unified Social Media Upload Script
...
def get_latest_reel():
    ...
    return {
        ...
        "metadata": metadata,
        "category": metadata.get("category_polish", "Polish Learning"),
...
def generate_caption(phrases, category, platform="facebook"):
    ...
    if platform == "facebook":
        ...
        caption_lines = [
            f"🇵🇱 Learn Polish with Velocity Polish! 🇵🇱",
            f"",
            f"📚 Category: {category}",
            f"",
            f"🎯 Master Polish one phrase at a time! Today's {category} lesson:",
            f""
        ]
        ...
        for i, phrase in enumerate(phrases[:5], 0):
            ...
            caption_lines.append(f"   📍 {phrase['polish']}")
        ...
        caption_lines.extend([
            ...
            f"🔔 Follow for daily Polish lessons!",
            f"",
...
def upload_to_all_platforms(video_path, caption, category):
    ...
    print("\n" + "="*80)
    print("🚀 VELOCITY POLISH - MULTI-PLATFORM UPLOAD")
    print("="*80)
...
def main():
    ...
    print("\n" + "="*80)
    print("🇵🇱 VELOCITY POLISH - AUTOMATED UPLOAD 🇵🇱")
    print("="*80)
